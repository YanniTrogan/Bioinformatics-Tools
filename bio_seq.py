...
class bio_seq:
    ...
    def __init__(self, seq = "ATCG", seq_type = "DNA", label = 'No Label'):
        ...
        assert self.is_valid, f"Provided data does not seem to be correct {self.seq} sequence"
    ...
    def generate_rnd_seq(self, length=10, seq_type="DNA"):
        ...
        self.__init__(seq, seq_type, "Randomly generate sequence")
    ...
    def gc_content(self): 
        ...
        return ((self.seq.count('C') + self.seq.count('G')) / len(self.seq) *100)
